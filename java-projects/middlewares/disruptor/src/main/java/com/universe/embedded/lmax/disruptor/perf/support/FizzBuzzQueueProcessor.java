 ...
 */
package com.universe.embedded.lmax.disruptor.perf.support;
            ...
            try {
                switch (fizzBuzzStep) {
                    case FIZZ: {
                        ...
                        fizzOutputQueue.put(0 == (value % 3));
                        break;
                    }

                    case BUZZ: {
                        Long value = buzzInputQueue.take();
                        buzzOutputQueue.put(0 == (value % 5));
                        break;
                    }

                    case FIZZ_BUZZ: {
                        final boolean fizz = fizzOutputQueue.take();
                        final boolean buzz = buzzOutputQueue.take();
                        if (fizz && buzz) {
                            ++fizzBuzzCounter;
                        }
                        break;
