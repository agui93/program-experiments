package stdlib.lib; /******************************************************************************
 *  Compilation:  javac stdlib.lib.In.java
 *  Execution:    java stdlib.lib.In   (basic test --- see source for required files)
 *  Dependencies: none
 *
...
public final class In {
   ...
   /**
    ...
    public In(File file) {
        ...
        try {
            // for consistency with stdlib.lib.StdIn, wrap with BufferedInputStream instead of use
   ...
   /**
     ...
     * @deprecated Replaced by {@code new stdlib.lib.In(filename)}.{@link #readAllInts()}.
     */
    @Deprecated
   ...
   /**
     ...
     * @deprecated Replaced by {@code new stdlib.lib.In(filename)}.{@link #readAllDoubles()}.
     */
    @Deprecated
   ...
   /**
     ...
     * @deprecated Replaced by {@code new stdlib.lib.In(filename)}.{@link #readAllStrings()}.
     */
    @Deprecated
   ...
   /**
     * Unit tests the {@code stdlib.lib.In} data type.
     *
