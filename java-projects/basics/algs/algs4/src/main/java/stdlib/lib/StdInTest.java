package stdlib.lib; /**
 * Test client for stdlib.lib.StdIn and stdlib.lib.In.
 **/
...
public class StdInTest {
    ...
    /**
     * stdlib.lib.In the two methods below, each Object[] of "steps" is a length-2
    ...
    public static void test(String input, Object[][] steps, boolean useStdIn) {
        ...
        if (useStdIn) {
            ...
            try { //call stdlib.lib.StdIn.resync();
    ...
    public static void main(String[] args) {
        ...
        if (testStdIn)
            ...
            StdOut.println("Note: stdlib.lib.StdIn.resync is private, only stdlib.lib.In will be tested.");
