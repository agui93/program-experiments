package stdlib.lib; /******************************************************************************
 *  Compilation:  javac stdlib.lib.StdIn.java
 *  Execution:    java stdlib.lib.StdIn   (interactive test of basic functionality)
 *  Dependencies: none
 *
...
/**
 * The {@code stdlib.lib.StdIn} class provides static methods for reading strings
 ...
 * p>
 * <b>Getting started.</b>
 * To use this class, you must have {@code stdlib.lib.StdIn.class} in your
 * Java classpath. If you used our autoinstaller, you should be all set.
 * Otherwise, either download
 * <a href = "https://introcs.cs.princeton.edu/java/code/stdlib.jar">stdlib.jar</a>
 * and add to your Java classpath or download
 * <a href = "https://introcs.cs.princeton.edu/java/stdlib/StdIn.java">stdlib.lib.StdIn.java</a>
 ...
 * <pre>
 * while (!stdlib.lib.StdIn.isEmpty()) {
 *     double value = stdlib.lib.StdIn.readDouble();
 *     stdlib.lib.StdOut.println(value);
 * }
 * </pre>
 * p>
 ...
 * <pre>
 * while (stdlib.lib.StdIn.hasNextChar()) {
 *     char c = stdlib.lib.StdIn.readChar();
 *     stdlib.lib.StdOut.print(c);
 * }
 * </pre>
 * p>
 ...
 * <pre>
 * while (stdlib.lib.StdIn.hasNextLine()) {
 *     String line = stdlib.lib.StdIn.readLine();
 *     stdlib.lib.StdOut.println(line);
 * }
 * </pre>
 * p>
 ...
 * <pre>
 * String[] words = stdlib.lib.StdIn.readAllStrings();
 * </pre>
 * p>
 * <b>Differences with Scanner.</b>
 * {@code stdlib.lib.StdIn} and {@link Scanner} are both designed to parse
 * tokens and convert them to primitive types and strings.
 * The main differences are summarized below:
 * <ul>
 * <li> {@code stdlib.lib.StdIn} is a set of static methods and reads
 ...
 *      and sockets.
 * <li> {@code stdlib.lib.StdIn} uses whitespace as the delimiter pattern
 *      that separates tokens.
 *      {@link Scanner} supports arbitrary delimiter patterns.
 * <li> {@code stdlib.lib.StdIn} coerces the character-set encoding to UTF-8,
 *      which is the most widely used character encoding for Unicode.
 * <li> {@code stdlib.lib.StdIn} coerces the locale to {@link Locale#US},
 *      for consistency with {@link StdOut}, {@link Double#parseDouble(String)},
 *      and floating-point literals.
 * <li> {@code stdlib.lib.StdIn} has convenient methods for reading a single
 *      character; reading in sequences of integers, doubles, or strings;
 *      and reading in all of the remaining input.
 * </ul>
 * p>
 * Historical note: {@code stdlib.lib.StdIn} preceded {@code Scanner}; when
 ...
 * Windows, and Linux.
 * The methods in {@code stdlib.lib.StdIn} are <em>blocking</em>, which means that they
 ...
 * If the input begins with the optional byte-order mask, {@code stdlib.lib.StdIn}
...
public final class StdIn {
    ...
    /*** begin: section (1 of 2) of code duplicated from stdlib.lib.In to stdlib.lib.StdIn. */
    ...
    /*** end: section (1 of 2) of code duplicated from stdlib.lib.In to stdlib.lib.StdIn. */
    ...
    //// begin: section (2 of 2) of code duplicated from stdlib.lib.In to stdlib.lib.StdIn,
    ...
    public static char readChar() {
        try {
            ...
            assert ch.length() == 1 : "Internal (Std)stdlib.lib.In.readChar() error!"
    ...
    //// end: section (2 of 2) of code duplicated from stdlib.lib.In to stdlib.lib.StdIn


    // do this once when stdlib.lib.StdIn is initialized
    static {
        resync();
    }

    /**
     * If stdlib.lib.StdIn changes, use this to reinitialize the scanner.
     */
