package stdlib.lib; /******************************************************************************
 *  Compilation:  javac stdlib.lib.Draw.java
 *  Execution:    java stdlib.lib.Draw
 *  Dependencies: none
 *
...
/**
 *  <i>stdlib.lib.Draw</i>. This class provides a basic capability for
...
public final class Draw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    // name of window
    private String name = "stdlib.lib.Draw";
    ...
    ***************************************************************************/
     ...
     *
     * @param listener the {\tt stdlib.lib.DrawListener} argument
     */
