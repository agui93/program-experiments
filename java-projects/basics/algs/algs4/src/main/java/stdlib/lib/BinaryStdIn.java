package stdlib.lib; /******************************************************************************
 *  Compilation:  javac stdlib.lib.BinaryStdIn.java
 *  Execution:    java stdlib.lib.BinaryStdIn < input > output
 *  Dependencies: none             
 *  
 *  Supports reading binary data from standard input.
 *
 *  % java stdlib.lib.BinaryStdIn < input.jpg > output.jpg
 ...
 *  byte first) order.
 *  <p>
 *  The client should not intermix calls to {@code stdlib.lib.BinaryStdIn} with calls
 *  to {@code stdlib.lib.StdIn} or {@code System.in};
...
public final class BinaryStdIn {
    ...
    private static boolean isInitialized;   // has stdlib.lib.BinaryStdIn been called for first time?
   ...
   /**
    ...
    public static void close() {
        ...
        try {
            ...
            throw new IllegalStateException("Could not close stdlib.lib.BinaryStdIn", ioe);
        }
    }
