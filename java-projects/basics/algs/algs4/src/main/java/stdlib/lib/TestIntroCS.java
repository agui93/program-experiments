...
/******************************************************************************
 *  Compilation:  javac-introcs stdlib.lib.TestIntroCS.java
 *  Execution:    java-introcs stdlib.lib.TestIntroCS n
 *
 *  Play chaos game to produce Barnsley's fern.
 *  This program is intended to test that stdlib.jar is properly installed.
 *
 *  % java-introcs stdlib.lib.TestIntroCS 10000
 *
 ******************************************************************************/
...
public class TestIntroCS {
    ...
    public static void main(String[] args) {
        int n = 100000;  // number of points to draw (default 10000)
        if (args.length == 1) {
