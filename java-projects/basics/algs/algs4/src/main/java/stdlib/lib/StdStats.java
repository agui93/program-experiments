package stdlib.lib; /******************************************************************************
 *  Compilation:  javac stdlib.lib.StdStats.java
 *  Execution:    java stdlib.lib.StdStats < input.txt
 *  Dependencies: stdlib.lib.StdOut.java
 *
 ...
 *  3.0 1.0 2.0 5.0 4.0
 *
 *  % java stdlib.lib.StdStats < tiny.txt
 *         min   1.000
 *        mean   3.000
 *         max   5.000
 *     std dev   1.581
...
/**
 * The {@code stdlib.lib.StdStats} class provides static methods for computing
...
public final class StdStats {
    ...
    /**
     * Unit tests {@code stdlib.lib.StdStats}.
