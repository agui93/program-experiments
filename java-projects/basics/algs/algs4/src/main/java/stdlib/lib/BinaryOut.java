package stdlib.lib; /******************************************************************************
 *  Compilation:  javac stdlib.lib.BinaryOut.java
 *  Execution:    java stdlib.lib.BinaryOut
 *  Dependencies: none
 *
 ...
 *  <p>
 *  The client should not intermix calls to {@code stdlib.lib.BinaryOut} with calls
 *  to {@code stdlib.lib.Out}; otherwise unexpected behavior will result.
 *
