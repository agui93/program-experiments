package stdlib.lib; /******************************************************************************
 *  Compilation:  javac stdlib.lib.DrawListener.java
 *  Execution:    none
 *  Dependencies: none
 *
 *  Interface that accompanies stdlib.lib.Draw.java.
 ******************************************************************************/

/**
 *  <i>stdlib.lib.DrawListener</i>. This interface provides a basic capability for
