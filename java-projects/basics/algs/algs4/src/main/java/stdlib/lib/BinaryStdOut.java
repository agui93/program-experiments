package stdlib.lib; /******************************************************************************
 *  Compilation:  javac stdlib.lib.BinaryStdOut.java
 *  Execution:    java stdlib.lib.BinaryStdOut
 *  Dependencies: none
 *
 ...
 * <p>
 * The client should not intermix calls to {@code stdlib.lib.BinaryStdOut} with calls
 * to {@code stdlib.lib.StdOut} or {@code System.out}; otherwise unexpected behavior
 * will result.
 *
...
public final class BinaryStdOut {
    ...
    private static boolean isInitialized;     // has stdlib.lib.BinaryStdOut been called for first time?

    // don't instantiate
    private BinaryStdOut() {
    }

    // initialize stdlib.lib.BinaryStdOut
