package stdlib.lib; /******************************************************************************
 *  Compilation:  javac stdlib.lib.GrayscalePicture.java
 *  Execution:    java stdlib.lib.GrayscalePicture imagename
 *  Dependencies: none
 *
 ...
 *
 *  % java stdlib.lib.GrayscalePicture mandrill.jpg
 *
 *  Remarks
 *  -------
...
public final class GrayscalePicture implements ActionListener {
   ...
   /**
     * Unit tests this {@code stdlib.lib.Picture} data type.
