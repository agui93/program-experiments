package stdlib.lib; /******************************************************************************
 *  Compilation:  javac stdlib.lib.BinaryIn.java
 *  Execution:    java stdlib.lib.BinaryIn input output
 *  Dependencies: none             
 *
 *  This library is for reading binary data from an input stream.
 *
 *  % java stdlib.lib.BinaryIn https://introcs.cs.princeton.edu/java/cover.png output.png
 *
 ******************************************************************************/
 ...
 * byte first) order.
 * <p>
 * The client should not intermix calls to {@code stdlib.lib.BinaryIn} with calls
 * to {@code stdlib.lib.In}; otherwise unexpected behavior will result.
 *
...
public final class BinaryIn {
    ...
    /**
     * Unit tests the {@code stdlib.lib.BinaryIn} data type.
