package stdlib.lib; /******************************************************************************
 *  Compilation:  javac stdlib.lib.StdArrayIO.java
 *  Execution:    java stdlib.lib.StdArrayIO < input.txt
 ...
 *    1 1 1
 *
 *  % cat tinyDouble1D.txt tinyDouble2D.txt tinyBoolean2D.txt | java stdlib.lib.StdArrayIO
 *  4
...
public class StdArrayIO {
   ...
   /**
     * Unit tests {@code stdlib.lib.StdArrayIO}.
     *
